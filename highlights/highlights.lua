local c = require('custom.highlights.colors')
local cfg = require('custom.highlights.config')
vim.cmd("hi Normal guifg=#b2b7cd guibg=#1f212b")
vim.cmd("hi NormalNC guifg=#b2b7cd guibg=#1f212b")
vim.cmd("hi EndOfBuffer guibg=#1f212b")
...
hl.common = {
    Normal = {fg = c.fg, bg = cfg.bg and c.none or c.bla1},
    ...
    DiffAdd = {fg = c.g, bg = c.none},
    DiffChange = {fg = c.b, bg = c.none},
    DiffDelete = {fg = c.r, bg = c.none},
...
hl.plugins.nvim_tree = {
    NvimTreeNormal = { fg = c.fg, bg = c.bla1 },
    NvimTreeEndOfBuffer = { fg = cfg.hide_ending_tildes and c.bg_d or c.bg2, bg = c.bla1 },
    ...
    NvimTreeSymlink = colors.Blue,
    NvimTreeRootFolder = colors.Purple,
    NvimTreeFolderName= colors.Purple,
    NvimTreeOpenedFolderName= colors.Purple,
    NvimTreeEmptyFolderName= colors.Purple,
...
hl.langs.crystal = {
    crystalLocalVariableOrMethod = { fg = "#b2b7cd" },
    crystalFunction = colors.White,
    crystalClassDeclaration = colors.Purple,
    crystalConstant = colors.Orange,
    crystalClass = colors.Purple,
    crystalDefine = colors.Purple,
    crystalString = colors.Green,
    crystalStringDelimiter = colors.Green,
    crystalControl = colors.Purple,
    crystalConditional = colors.Purple,
    crystalConditionalModifier = colors.Purple,
    crystalConditionalExpression= { fg = c.orange, italic = true},
    crystalBoolean= colors.Red,
    crystalSymbol= colors.Cyan,
    crystalBlockParameter= colors.Cyan,
    crystalKeyword= colors.Purple,
    crystalPseudoVariable= colors.Purple,
    crystalInteger= colors.Red,
    crystalFloat= colors.Red,
    crystalException= colors.White,
    crystalInterpolationDelim= colors.Blue,
    crystalInterpolation= colors.Cyan,
}
hl.langs.markdown = {
...
hl.langs.ruby = {
    rubyClass = colors.Cyan,
    rubyClass = colors.Cyan,
    rubyString = colors.Purple
}
